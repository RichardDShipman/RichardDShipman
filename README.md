...
- TEXT_RAG [Link](https://github.com/RichardDShipman/TEXT_RAG) - A RAG that constructs a ChromaDB vector database for LLM querying of PDFs, HTMLs, and TXT files.
...
1.  **[In-depth Site-Specific O-Glycosylation Analysis of Glycoproteins and Endogenous Peptides in Cerebrospinal Fluid (CSF) from Healthy Individual, Mild Cognitive Impairment (MCI) and Alzheimer’s disease (AD) patients](https://pubmed.ncbi.nlm.nih.gov/34964596/)**

      * Z. Chen, Q. Yu, J. Johnson, **R. Shipman**, X. Zhong, J. Huang, S. Asthana, C. Carlsson, O. Okonkwo, L. Li
      * *Published: December 2021*

2.  **[Simultaneous Enrichment and Separation of Neutral and Sialyl Glycopeptides of SARS-COV-2 Spike Protein Enabled by Dual-functionalized Ti-IMAC Material](https://link.springer.com/article/10.1007/s00216-021-03433-1)**

      * J. Huang, W. Danqing, **R. Shipman**, Z. Zexin, L. Yuan, L. Li
      * *Published: June 2021*

3.  **[In-depth site-specific analysis of N-glycoproteome in human cerebrospinal fluid (CSF) and glycosylation landscape changes in Alzheimer's disease (AD)](https://pubmed.ncbi.nlm.nih.gov/33862227/)**
